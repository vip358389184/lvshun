...
function msg(tip,t) {t=t || 3000;top.layer.msg(tip,{opacity:0.4,time:t,skin:'layer-msg'});}
function error(tip,t){t=t || 3000;top.layer.alert(tip,{opacity:0.4,time:t,icon:2});}