    ...
    <div id="head_hot_goods_content" >
        <ul>
            <li class="floor_goods_wrap_li"  ng-repeat="(x, value) in myObj">
                ...
                <a style="color:  #FF6700;margin-top: 20px;"  ng-click="findById(value.c_id,value.retail_price,value.c_name,value.label)"onclick="a()">{{value.retail_price}}元</a>
            </li>
        </ul>
    </div>
</div>
...
<div id="main_show_box">
    ...
    <div class="floor_goods_wrap" >
        <ul>
            ...
            <li class="floor_goods_fu"  ng-repeat="(x, value) in  yi">
                ...
                <a ng-click="findById(value.c_id,value.retail_price,value.c_name,value.picture,value.label)" onclick="a()" class="floor_goods_price">{{value.retail_price}}元</a>
            </li>
