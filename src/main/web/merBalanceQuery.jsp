...
<body> 
    <form action="../merBalanceQueryServlet" method="post" onsubmit="return checks(this)">
    	<table class="table_ui" align="center">
        	<tr>
                <td colspan="5" align="center">商户余额查询</td>
            </tr>
            
             <tr>
             	<td align="right">商户编号:</td>
                <td colspan="4"> 
                <input style="width:300px" name="merId" type="text" value="" >
