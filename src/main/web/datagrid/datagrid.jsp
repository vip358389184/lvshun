...
<head>
    ...
    <script type="text/javascript">
        ...
        function openUserModifyDialog() {
            ...
            $("#fm").form("load", row);
            $.post(url="/user/getbyid?userid="+selectrow[0].id);
        }
...
<div id="tb">
    <a onclick="openUserAddDialog()" class="easyui-linkbutton"
       iconCls="icon-add" plain="true">添加</a> <a
        onclick="openUserModifyDialog()" class="easyui-linkbutton"
        iconCls="icon-edit" plain="true">修改</a> <a
        onclick="deleteUser()"class="easyui-linkbutton"
        iconCls="icon-remove" plain="true">删除</a>
    <div>
        &nbsp;用户名：&nbsp;<input type="text" id="s_userName" size="20"
                               onkeydown="if(event.keyCode == 13)searchUser()" /> <a
            onclick="searchUser()"  class="easyui-linkbutton"
            iconCls="icon-search" plain="true">查询</a>
    </div>

    <div id="dlg-buttons">
        <a onclick="saveUser()" class="easyui-linkbutton"
           iconCls="icon-ok">保存</a> <a onlick="closeUserDialog()"
    ...
    <div id="dlg" class="easyui-dialog"
        ...
        <form method="post" id="fm">
            <table cellspacing="8px;">
                <tr>
                    <td width="300px;">用户ID：</td>
                    <td><input type="text" id="id" name="userid"
                               class="easyui-validatebox" required="true" />${user.userId }<span
