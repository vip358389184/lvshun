...
public class SystemInfoLogVO {
	...
	public SystemInfoLogVO(String hostname,String hostip,Timestamp scantime,String cpu_used,
			String mem_total,String mem_used,String net_name,String net_used,String net_err,
			String net_drop,String hd_name1,String hd_used1,String hd_name2,String hd_used2,
			String hd_name3,String hd_used3) {
		this.hostname = hostname;
		this.hostip = hostip;
		this.scantime = scantime;
		this.cpu_used = cpu_used;
	...
	public SystemInfoLogVO() {}
	
	
	@Override
	public String toString() {
		return "SystemInfoLogVO [hostname=" + hostname + ", hostip=" + hostip + ", scantime="
				+ scantime + ", cpu_used=" + cpu_used + ", mem_total=" + mem_total +
				 ", mem_used=" + mem_used + ", net_name=" + net_name + ", net_used=" + net_used + 
				 ", net_err=" + net_err + ", net_drop=" + net_drop + ", hd_name1=" + hd_name1 + 
				 ", hd_used1=" + hd_used1 + ", hd_name2=" + hd_name2 + ", hd_used2=" + hd_used2 + 
